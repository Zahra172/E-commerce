...
export default function Footer() {
  return (
    <div className="pt-11 pb-11 px-6 bg-gray-50 text-black dark:text-white dark:bg-gray-700">
      <div className="my-3 ">
        <h2 className="text-2xl my-1 font-semibold">Get the FreshCart app</h2>
        <p className="text-sm text-gray-600 dark:text-gray-300">We will send you a link, open it in your phone to download the app.</p>
      </div>
      <form className="pb-10 w-full flex flex-col sm:flex-row gap-4 mx-4">
        ...
        <button className="bg-pink-700 w-full sm:w-1/4 hover:bg-pink-600 p-2 rounded-lg text-white mt-4 sm:mt-0">
          Share app link
        </button>
      </form>
      <div className="flex flex-col sm:flex-row justify-between items-center mt-6">
        <div className="mb-4 sm:mb-0">
          <ul className="flex flex-wrap space-x-4 items-center justify-center">
            ...
            <li>
              <img
                src="https://via.placeholder.com/50x30?text=AmazonPay"
                alt="Amazon Pay"
                className="h-8"
              />
            </li>
        ...
        <div>
          <ul className="flex flex-wrap space-x-4 items-center justify-center">
            <li className="text-lg font-medium">Get deliveries with FreshCart:</li>
            <li>
              <img
                src="https://via.placeholder.com/50x30?text=App+Store"
                alt="App Store"
                className="h-8"
              />
            </li>
            <li>
              <img
                src="https://via.placeholder.com/50x30?text=Google+Play"
                alt="Google Play"
                className="h-8"
              />
            </li>
